...
=======
>>>>>>> df2e841ccd3d2dd4f85b6418ed4bc0f6157745c7
```
...
ggplot(reshaped.predictions, aes(x = percent_white, y = Probability, colour = Level)) +
  geom_smooth(se = F) + 
  labs(title = "Probability of Meeting Standards by Percent White") + theme_bw()


ggplot(reshaped.predictions, aes(x = percent_ACT_meeting, y = Probability, colour = Level)) +
  geom_smooth(se = F) + 
  labs(title = "Probability of Meeting Standards by Percent Meeting ACT Standards") + theme_bw()
