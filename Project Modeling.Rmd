...
pkgs <- c("tidyverse", "ggplot2", "ggpubr", "cowplot", "reshape2", "caTools", "MASS")
...
psych::pairs.panels(numeric.cols[c(ncol(numeric.cols), 1:4)],
                    smooth = FALSE,
                    pch = 1,
                    ellipses = FALSE,
                    hist.col = "#80b1d3")
